#include "ImageWaveformComponent.h"


namespace Capture3
{

	ImageWaveformComponent::ImageWaveformComponent() :
		PanelTabComponent("Waveform"),
		groupRGB("Waveform - RGB"),
		groupHSB("Waveform - HSB"),
		groupXYZ("Waveform - XYZ"),
		groupXYV("Waveform - xyY"),
		groupLAB("Waveform - LAB"),
		itemRGB_R(),
		itemRGB_G(),
		itemRGB_B(),
		itemHSB_H(),
	...
	void ImageWaveformComponent::show(const Image *image)
	{
		// Generate images
		generateWaveform(
			image->getSize(),
	...
	void ImageWaveformComponent::reset()
	{
		itemRGB_R.reset();
		itemRGB_G.reset();
		itemRGB_B.reset();
